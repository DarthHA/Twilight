...
{
    public class MeleeSharp : ModProjectile
    {
        float Timer = 0;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Timer = (Timer + 1) % 60;
            DrawUtils.DrawShotTrail(texExtra, texExtra2, vertexInfos, Main.spriteBatch, Color.Orange, BlendState.Additive, 1 - Timer / 60f);
